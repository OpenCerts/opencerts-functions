...
To run e2e tests locally, you first need to setup the correct environment variables:
```
NETWORK=ropsten
EMAIL_API_KEYS=e2e_test_api_key

SES_KEY_ID=/* ask to a teammate */
SES_SECRET=/* ask to a teammate */
SES_REGION=us-west-2
```

You can provide the environment variables the way you prefer. The simplest way is to copy the values above, into a `.env` file, located at the root of the project. Once the environment variables are correctly setup, run the following commands:
